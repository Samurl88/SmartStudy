    ...
    return (
        <div id='main' className="font-mono">
            ...
            <div className="flex flex-col items-center justify-center">
                <a className="btn btn-secondary btn-lg" variant="contained" href="/mycourses" >Go to My Courses</a>
                {
                    localStorage.getItem("email") == null ? <p className="font-medium text-base">Or <Link to="/login" className="text-sky-500">Login</Link> or <Link to="/register" className="text-sky-500">Register</Link></p>: null
                }
            </div>
            <br />
            <div className="m-20">
                <div className="text-xl font-bold pb-10">
                    <h2 className="pb-5">"An investment in knowledge pays the best interest."</h2>
                    <h3 id="name">-Benjamin Franklin</h3>
                </div>
            
            <div id="firstP" className="flex justify-evenly items-center gap-20">
            ...
            <div className="flex justify-center">
                <div className="grid-cols-12 grid m-12 gap-10 place-content-center">
                    <div className="card flex col-span-3 h-70 rounded-xl w-96 text-primary-content border border-primary">
            ...
            <div className="flex justify-evenly items-center gap-20" id='secondP'>
